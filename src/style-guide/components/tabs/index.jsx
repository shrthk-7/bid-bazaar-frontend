...
export default function Tabs() {
  ...
  const [color2, setColor2] = useState("var(--profilecard-bg1)");
  const [isClicked3, setIsClicked3] = useState(false);
  const [color3, setColor3] = useState("var(--profilecard-bg1)");
  const [isClicked4, setIsClicked4] = useState(false);
  const [color4, setColor4] = useState("var(--profilecard-bg1)");
  function filter1() {
    setColor1("var(--heroSection-bg2)");
    setColor2("var(--profilecard-bg1)");
    setColor3("var(--profilecard-bg1)");
    setColor4("var(--profilecard-bg1)");
    setIsClicked1(true);
    setIsClicked2(false);
    setIsClicked3(false);
    setIsClicked4(false);
